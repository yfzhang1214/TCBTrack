...
#from yolox.tracker.my_byte_tracker_mot17 import BYTETracker#################################################################修改！！！
    ...
    def evaluate_my(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                self.args.track_thresh = ori_thresh
                self.args.track_buffer = 30
                #params=[-100,0.9,100,-100,-100]#match2-1,1-iou1,match1-iou,match2-2
                params=[0.7,0.4,0.2,-100,0.1]
                #if video_name == 'MOT17-05-FRCNN':
                #    params=[0.7,0.4,0.2,-100,0.1]
                #if video_name == 'MOT17-13-FRCNN' or video_name == 'MOT17-04-FRCNN':
                #    params=[-100,-100.9,100,-100,-100]
                    
                #if video_name == 'MOT17-10-FRCNN':
                #    params=[0.5,0.1,0.5,0.3]
                    #self.args.match_thresh = 0.7
                #params=[100,1.1,0.5,-100]
                #params=[-100,0.9,0.5,-100]
