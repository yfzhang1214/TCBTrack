    ...
    def __getitem__(self, idx):
        if self.enable_mosaic:
            ...
            for i_mosaic, index in enumerate(indices):
                img, _labels, _, _ ,_= self._dataset.pull_item(index)     # _labels format: tlbr(absolute value) + class_id + track_id
            ...
            img, label, img_info, id_,_ = self._dataset.pull_item(idx)
