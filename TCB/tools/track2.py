...
def make_parser():
    ...
    parser.add_argument("--nms", default=0.7, type=float, help="test nms threshold")#从0.7修改到0.6
    parser.add_argument("--tsize", default=None, type=int, help="test img size")
    parser.add_argument("--seed", default=None, type=int, help="eval seed")
    # tracking args
    parser.add_argument("--track_thresh", type=float, default=0.6, help="tracking confidence threshold")
    parser.add_argument("--track_buffer", type=int, default=30, help="the frames for keep lost tracks")
    parser.add_argument("--match_thresh", type=float, default=0.9, help="matching threshold for tracking")#0.9修改到0.7
...
def main(exp, args, num_gpu):
    ...
    *_, summary = evaluator.evaluate_TCB(
    ...
    if exp.val_ann == 'val_half.json':
        ...
        gt_type = ''
    if exp.val_ann == 'val_half2.json':
        gt_type = '_val_half2'
    if exp.val_ann == 'val_half3.json':
        gt_type = '_val_half3'
    ...
    gtfiles = glob.glob((os.path.join('datasets/dancetrack/val', '*/gt/gt_2.txt')))
